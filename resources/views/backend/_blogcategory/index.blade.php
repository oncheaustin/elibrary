                ...
                <table id="courses-table" class="table table-condensed table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{trans('strings.backend.no-of-posts')}}</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($blog_categories as $category)
                            <tr>
                                ...
                                <td>
                                    {!! Form::open(['route' => ['admin.blog.categories.destroy', $category], 'method'=>'POST', 'class' => 'form-horizontal delete-category-form']) !!} 
                                        <a href="{{ route('admin.blog.categories.edit', $category) }}" class="btn btn-xs btn-success edit">{{trans('strings.backend.edit')}}</a>
