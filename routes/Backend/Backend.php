...
Route::delete('categories/{category}/delete', 'AdminCategoryController@destroy')->name('categories.destroy');
...
Route::delete('blog-categories/{category}/delete', 'AdminBlogCategoryController@destroy')->name('blog.categories.destroy');
...
Route::delete('pages/{post}/{locale}/delete', 'AdminBlogController@destroy')->name('pages.destroy');
