...
// course payment
Route::get('/payment/course/{course}/checkout', 'StripePaymentController@checkout')->name('courses.checkout');
Route::post('/courses/charge', 'StripePaymentController@charge')->name('courses.charge');
Route::post('/courses/charge/paypal', 'PayPalPaymentController@charge')->name('courses.charge.paypal');
Route::get('/courses/charge/paypal', 'PayPalPaymentController@paymentStatus')->name('courses.charge.paypal.status');

Route::post('/courses/charge/braintree', 'BraintreeController@charge')->name('courses.charge.braintree');
...
// coupon
Route::post('/courses/coupon', 'StripePaymentController@applyCoupon')->name('course.coupon.apply');    
